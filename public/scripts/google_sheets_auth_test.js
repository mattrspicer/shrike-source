...
shrikeApp.controller('google_sheets_auth_test_controller', function($scope, $http) {
    ...
    (function() {
        ...
        var J = function(a, b, c) {
            ...
            L = function(a, b, c) {
                b && 0 < b.length && (b = K(b), c && 0 < c.length && (b += "___" + K(c)), 28 < b.length && (b = b.substr(0, 28) + (b.length - 28)), c = b, b = u(ca, "_p", x()), u(b, c, x())[a] = (new Date).getTime(), J(a, "_p", c))
            },
            K = function(a) {
        ...
        N.push(["jsl", function(a) {
            for (var b in a)
                if (Object.prototype.hasOwnProperty.call(a, b)) {
                    var c = a[b];
                    "object" == typeof c ? B[b] = u(B, b, []).concat(c) : u(B, b, c)
                }
            if (b = a.u) a = u(B, "us", []), a.push(b), (b = /^https:(.*)$/.exec(b)) && a.push("http:" + b[1])
        }]);
        var da = /^(\/[a-zA-Z0-9_\-]+)+$/,
            ea = /^[a-zA-Z0-9\-_\.,!]+$/,
            fa = /^gapi\.loaded_[0-9]+$/,
            ...
            ka = function(a, b, c, d) {
                var e = a.split(";"),
                    ...
                    l = M[f],
                    k = null;
                l ? k = l(e, b, c, d) : O("no hint processor for: " + f);
                k || O("failed to generate load url");
                b = k;
                c = b.match(ha);
                (d = b.match(ia)) && 1 === d.length && ja.test(b) && c && 1 === c.length || O("failed sanity: " + a);
                return k
            },
            ma = function(a, b, c, d) {
                a = la(a);
                fa.test(c) || O("invalid_callback");
                b = P(b);
        ...
        var R = decodeURI("%73cript"),
            ...
            T = function(a, b) {
                for (var c = [], d = 0; d < a.length; ++d) {
                    var e = a[d];
                    e && 0 > w.call(b, e) && c.push(e)
                }
                return c
            },
            U = function() {
                var a = B.nonce;
                if (void 0 !== a) return a && a === String(a) && a.match(S) ? a : B.nonce = null;
                var b = u(B, "us", []);
                if (!b || !b.length) return B.nonce = null;
                for (var c = h.getElementsByTagName(R), d = 0, e = c.length; d < e; ++d) {
                    ...
                    if (f.src && (a = String(f.getAttribute("nonce") || "") || null)) {
                        ...
                        if (l !== k && a && a === String(a) &&
                            a.match(S)) return B.nonce = a
                    }
                }
                return null
            },
            oa = function(a) {
                if ("loading" != h.readyState) W(a);
                else {
                    var b = U(),
                        c = "";
                    null !== b && (c = ' nonce="' + b + '"');
            ...
            Y = function(a, b, c) {
                ...
                var k = u(D(c), "r", []).sort(),
                    ...
                    V = function(a, b) {
                        ...
                        H.push.apply(H,
                            p);
                        var d = ((A || {}).config || {}).update;
                        d ? d(e) : e && u(B, "cu", []).push(e);
                        if (b) {
                            L("me0", a, E);
                            try {
                                qa(b, c, v)
        ...
        var X = function(a, b) {
            if (B.hee && 0 < B.hel) try {
                return a()
            }
            catch (c) {
                b && b(c), B.hel--, Z("debug_error", function() {
                    try {
    ...
    gapi.load("client", {
        ...
        _c: {
            "jsl": {
                ...
                "h": "m;/_/scs/apps-static/_/js/k=oz.gapi.en.CUXyo_wPfp0.O/m=__features__/am=AQ/rt=j/d=1/rs=AGLTcCMYqx5cA6SdMRKSM5YaRVPo-xpcPg",
                "u": "https://apis.google.com/js/client.js?onload=checkAuth",
                "hee": true,
                "fp": "26ee08ac90e7598eab636a1fcb13d45e1b78d432",
                "dpo": false
            },
            "fp": "26ee08ac90e7598eab636a1fcb13d45e1b78d432",
    ...
    var CLIENT_ID = '615983396791-3h2p24jfkas9qris9g8t13hg65i1012l.apps.googleusercontent.com';
    ...
    $scope.test = function() {
        ...
        // var data = {"name":"test","email":"test@test.com"};
        var data = {};
        var config = {};
        var destination = "https://script.google.com/macros/s/AKfycbx66PacR2gXE_b9aHX9yI7pQ9-CS5QVYp6cJkSSxEa4Js7fCDMJ/exec";
        $http.post(destination, data).then(success, fail);
